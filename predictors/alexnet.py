...
class AlexnetFood(nn.Module):
    def __init__(self, name, n_outputs=10, return_feature_domain=False):
        ...
        self.conv5 = nn.Conv2d(192, 128, 3, stride=1, padding=3)
        self.conv5.bias.data.normal_(0, 0.01)
        self.conv5.bias.data.fill_(1.0)  
        ...
        self.batch_norm6 = nn.BatchNorm1d(2048, eps=0.001)
        
        self.fc2 = nn.Linear(2048,2048)
        self.fc2.bias.data.normal_(0, 0.01)
        self.fc2.bias.data.fill_(0) 
        
        self.batch_norm7 = nn.BatchNorm1d(2048, eps=0.001)
